# 1 "user.c"
# 1 "C:\\Users\\3\\Desktop\\RGR_LEDstrip.X//"
# 1 "<command-line>"
# 1 "user.c"
# 12 "user.c"
...
# 17 "user.c" 2
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\string.h" 1 3
# 14 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\string.h" 3
...
void init_gpio(void)
{
    ...
    LATGbits.LATG6 = LATDbits.LATD4 = LATBbits.LATB11 = LATGbits.LATG15 = 0;
...
void InitTimer2AndOC5And4And8(void)
{
    ...
    PR2 = (100000000/(256*(1000))) - 1;


    OC8R = (100000000/(256*(1000))) / 2;

    OC8RS = (100000000/(256*(1000))) / 2;
    ...
    OC5R = (100000000/(256*(1000))) / 2;

    OC5RS = (100000000/(256*(1000))) / 2;
    ...
    OC4R = (100000000/(256*(1000))) / 2;

    OC4RS = (100000000/(256*(1000))) / 2;
...
void delay(__uint32_t n)
{
    volatile __uint32_t i;
    for (; n > 0; n--) {
        for (i = 0; i < 10000; i++)
            ;
    }
